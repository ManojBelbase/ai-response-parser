...
const CodeBlock = ({ language, code, theme }) => {
    ...
    return (jsxRuntimeExports.jsxs("div", { style: {
            ...
            border: '1px solid #444'
                    ...
                    borderBottom: '1px solid #444'
                }, children: [jsxRuntimeExports.jsx("span", { style: { color: '#888', fontSize: '0.875rem' }, children: language || 'code' }), jsxRuntimeExports.jsx("button", { onClick: handleCopy, style: {
                        ...
                        }, children: copied ? 'Copied!' : 'Copy' })] }), jsxRuntimeExports.jsx("pre", { style: {
                    margin: 0,
                    padding: '16px',
                    background: '#1e1e1e',
                    overflow: 'auto',
                    fontSize: '0.9rem',
                    lineHeight: '1.5'
                }, children: jsxRuntimeExports.jsx("code", { dangerouslySetInnerHTML: { __html: highlight(code, theme) } }) })] }));
};
